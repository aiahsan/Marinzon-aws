...
import { UpdateVendorDocuments } from "../../../functions/Vendor";
function App() {
    ...
    <Layout title=" ">
      <div className="main-div">
        <div className="hdsf0s-sadmsa mt-3 p-an ml-0">
          <h5 className="cst-mx-0 ">Document Details</h5>
        </div>
      </div>
          ...
          <div className="mt-4">
            <Formik
              initialValues={{
                ...
                tradeLicenseId: parms?.state?.data?.tradeLicenseId ||"",
                                //@ts-ignore

                nationCardId:parms?.state?.data?.nationCardId ||"",
              }}
                  ...
                  <>
                    <DocumentForm
                      ...
                      docvalues={{
                        ...
                        let value=await  dispatch(UpdateVendorDocuments({...values}));
                        //@ts-ignore
                         if(value && value==1)
                         {
                           // setData(undefined)
